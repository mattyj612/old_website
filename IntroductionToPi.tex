...
\usepackage{graphicx}
\usepackage[colorlinks=true, linkcolor=blue, urlcolor=blue, pdfnewwindow=True]{hyperref}
\usepackage{titlepic}
\usepackage{color}
...
\centering
\vspace{-0.3cm}
\includegraphics[scale=0.45]{LineCurve}
